...
const scenes = {
  ...
  forestEdge: {
    ...
    narration: "narrationForestEdge.mp3",
  },
  echoes: {
  ...
  pathCinders: {
    ...
    narration: "narrationPathCinders.mp3",
  },
  forgottenPath: {
    ...
    narration: "narrationForgottenPath.mp3",
  },
  rootsMemory: {
    ...
    narration: "narrationRootsMemory.mp3",
  },
  mazeAsh: {
    ...
    narration: "narrationMazeAsh.mp3",
  },
  mazeEchoes: {
    ...
    narration: "narrationMazeEchoes.mp3",
  },
  mazeEyes: {
    ...
    narration: "narrationMazeEyes.mp3",
  },
  mazeStillWater: {
    ...
    narration: "narrationStillWater.mp3",
  },
  shrineLantern: {
    ...
    narration: "narrationShrineLantern.mp3",
  },
  keeperRevealed: {
  ...
  voiceFlame: {
    ...
    choices: [{ text: "Play Again", next: "start" }],
    narration: "narrationVoiceFlame.mp3",
    music: "/mysteriousloopsnippit.mp3",
  },
  hiddenEnding: {
